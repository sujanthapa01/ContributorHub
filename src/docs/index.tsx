    ...
    <div className="min-h-screen bg-gray-50 bg-background ">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          {/* Sidebar */}
          <aside
            className={`md:w-64 w-full md:flex-shrink-0 ${isMobileMenuOpen ? 'block' : 'hidden'
              } md:block`}
          >
          ...
          <main className='flex flex-col flex-grow px-4 sm:px-6 lg:px-8'>
            ...
            {/* Community */}
            <section id="community" className="mb-8 sm:mb-12 lg:mb-16 scroll-mt-24">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 lg:p-8">
                <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 mb-4 sm:mb-6">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Community</h2>
                </div>

                <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 leading-relaxed">
                  Contribute, explore our docs, and connect with others through GitHub and our blog.
                </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                  ...
                  <div className="text-center p-4 sm:p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">GitHub</h3>
                    <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4">Contribute to our codebase, report issues, and suggest improvements.</p>
                    <a
                  ...
                  <div className="text-center p-4 sm:p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">Blog</h3>
                    <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4">Read tutorials, updates, and contributor stories.</p>
                    <a
                      href="/blog"
                      className="text-blue-600 hover:text-blue-700 font-medium text-xs sm:text-sm"
                    >
                  ...
                  <div className="text-center p-4 sm:p-6 border border-gray-200 rounded-lg hover:shadow-md transition-shadow sm:col-span-2 lg:col-span-1">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">New Contributor Guide</h3>
                    <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4">Start contributing with our easy onboarding docs.</p>
                    <a
                      href="#contributors"
                      className="text-blue-600 hover:text-blue-700 font-medium text-xs sm:text-sm"
                    >
